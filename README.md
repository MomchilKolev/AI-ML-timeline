...
4. Use `http-server` to quickly start up a local server; from your code's folder run `npx http-server`. You should see a timeline of the history of Artificial Intelligence and Machine Learning.
